    ...
    <div class="p-6 card invoice-preview-card p-sm-12">
        ...
        <div class="flex-wrap d-flex flex-column flex-sm-row justify-content-between text-heading">
          ...
          <div class="col-md-5 col-8 pe-0 ps-0 ps-md-2">
            <dl class="mb-0 row gx-4">
              ...
              <dd class="col-sm-7">
                <input type="text" class="form-control" disabled="" value="" wire:model='invoice_id'>
              </dd>
              <dt class="mb-1 col-sm-5 d-md-flex align-items-center justify-content-end">
                <span class="fw-normal">Date Issued:</span>
              </dt>
              <dd class="col-sm-7">
                <input type="text" class="form-control" wire:model='date_issued' id="date_issued">
              </dd>
      ...
      <div class="px-0 card-body">
        <div class="row">
          <div class="mb-6 col-md-6 col-sm-5 col-12 mb-sm-0">
            <h6>Invoice To:</h6>
            <select class="mb-4 form-select w-50" wire:model.live="selectedClient">
            ...
            <div class="w-50">
              @foreach ( $clientSelected as  $data)
                <p class="mb-1">{{ $data->business_address }}</p>
                <p class="mb-1">{{ $data->phone_number }}</p>
                <p class="mb-0">{{ $data->email_address }}</p>
              @endforeach
            </div>
          </div>
      ...
      <div class="px-0 pt-0 card-body">
        <form class="item_form" id="item_form">
          <div class="mb-4 item-container" >
            <div class="pt-0 repeater-wrapper pt-md-9 item" data-repeater-item="">
              <div class="border rounded d-flex position-relative pe-0">
                <div class="p-6 row w-100 g-6">
                  <div class="mb-4 col-md-6 col-12 mb-md-0">
                    <p class="h6 repeater-title">Item
                    </p>
                    <select class="mb-6 form-select item-details">
                      ...
                      <option value="ABC Template">ABC Template
                      </option>
                      <option value="App Development">App Development
                      </option>
                    </select>
                    <textarea class="form-control" rows="2" placeholder="Customization &amp; Bug Fixes">
                    </textarea>
                  </div>
                  <div class="mb-4 col-md-3 col-12 mb-md-0">
                    <p class="h6 repeater-title">Cost
                    </p>
                    <input type="text" class="mb-5 form-control invoice-item-price" placeholder="24" min="12">
                    <div class="text-heading">
                      <div class="mb-1">Discount:
                      </div>
                      <span class="discount me-2">0%
                      </span>
                      <span class="tax-1 me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Tax 1">0%
                      </span>
                      <span class="tax-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Tax 2">0%
                      </span>
                    </div>
                  </div>
                  <div class="mb-4 col-md-2 col-12 mb-md-0">
                    <p class="h6 repeater-title">Qty
                    </p>
                    <input type="text" class="form-control invoice-item-qty" placeholder="1" min="1" max="50">
                  </div>
                  <div class="mt-8 col-md-1 col-12 pe-0">
                    <p class="h6 repeater-title">Price
                    </p>
                    <p class="mb-0 text-heading">$24.00
                    </p>
                  </div>
                </div>
                <div class="p-2 d-flex flex-column align-items-center justify-content-between border-start">
                  <i class="cursor-pointer icon-base bx bx-x icon-lg remove_item">
                  </i>
                  <div class="dropdown">
                    <i class="cursor-pointer icon-base bx bx-cog icon-lg more-options-dropdown" role="button" id="dropdownMenuButton" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"> 
                    </i>
                    <div class="p-4 dropdown-menu dropdown-menu-end w-px-300" aria-labelledby="dropdownMenuButton">
                      ...
                      <div class="my-4 dropdown-divider">
                      </div>
                      <button type="button" class="btn btn-label-primary btn-apply-changes">Apply
                      </button>
                    </div>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-12">
              <button type="button" class="btn btn-sm btn-primary" id="add_items">
    ...
    <div class="mb-6 card">
      <div class="card-body">
        ...
        <button type="button" class="btn btn-primary d-grid w-100">
          <span class="d-flex align-items-center justify-content-center text-nowrap"><i class="icon-base bx bx-paper-plane icon-xs me-2"></i>Send</span>
        </button>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  window.addEventListener('search_date', event => {
    ...
    setTimeout(() => {
      const ids = ["date_issued", "due_date"];
    ...
    $("#add_items").click(function() {
      var newItem = $(".item").first().clone(); // Clone the first original .item
      newItem.find("input").val(""); // Clear input values
      newItem.hide().appendTo(".item-container").fadeIn(300); // Hide, append, then fade in
    });

    $('#item_form').on('click', '.remove_item', function() {
      if ($('.item').length > 1) {
